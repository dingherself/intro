...
{{ site.course_number }} counts as an Arts & Humanities course for Barnard’s Foundations curriculum.
...
<div class="alert alert-light" role="alert">
  <span style="font-size: 0.93rem;">NB: Butler Library has <a href="https://clio.columbia.edu/catalog/SCSB-8274543">one circulating</a> and <a href="https://clio.columbia.edu/catalog/6426880">one non-circulating copy</a>.</span>
</div>
...
<div class="alert alert-light" role="alert">
  <span style="font-size: 0.93rem;">NB: Columbia has <a href="https://clio.columbia.edu/catalog/6225032">two copies</a>.</span>
</div>

- Audre Lorde, *Sister Outsider: Essays and Speeches* (Trumansburg, NY: Crossing, 1984). Paperback, 978-1580911863, \$17.99.

<div class="alert alert-light" role="alert">
  <span style="font-size: 0.93rem;">NB: Barnard has <a href="https://clio.columbia.edu/catalog/308755">four copies</a> and Columbia a few more.</span>
</div>
I have asked [Book Culture](https://www.bookculture.com/) to order all six as recommended texts. You can usually find excellent bargains from used bookstores too (e.g., try searching on [BookFinder](https://www.bookfinder.com/)). [Bookshop](https://bookshop.org/) is another place to shop independent bookstores, although they don’t always have academic titles in stock.
...
For this class, I will use in-class activities (which will be graded for completion) to establish a baseline participation grade, and then move up or down taking into account preparation, engagement, contribution, and [respect for others]({{ site.baseurl }}{% link course-policies.md %}#respect-support-and-care-for-one-another). Class participation will make up 15% of your final grade.
...
While I will provide prompts for both the paper and open options, you are also more than welcome to work with me to craft your own—if this is something you would like to do, please meet with me **by Wednesday, November 19** to discuss your idea. If we can both see a workable final project, I will then ask you to write up a short project proposal to finalize it. You are not required to get my permission or submit a proposal if you decide to pursue one of the pre-circulated prompts. Either way, the final project is due **by 11:59pm on Wednesday, December 17**.
