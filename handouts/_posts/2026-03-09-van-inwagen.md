...
- Here, we want to avoid prematurely assuming that one side of a live debate is correct by definitional fiat: if free will is, as [*Merriam-Webster*](https://www.merriam-webster.com/dictionary/free%20will) says, “freedom of humans to make choices that are not determined by prior causes or by divine intervention,” then that already prejudically settles the question of whether casual determinism or divine foreknowledge precludes free will.
...
<table class="tg mb-5"><thead>
  <tr>
    <th class="tg-lhti" colspan="3">Views</th>
    <th class="tg-lhti">(1) Free will</th>
    <th class="tg-lhti">(2) Compatibility</th>
    <th class="tg-lhti">(3) Determinism</th>
  </tr></thead>
<tbody>
  <tr>
    <td class="tg-wa1i" rowspan="3">Incompatibilism</td>
    <td class="tg-wa1i" colspan="2">Libertarianism</td>
  ...
  <tr>
    <td class="tg-amwm">Hard non-determinist incompatibilism</td>
    <td class="tg-baqh">False</td>
    <td class="tg-baqh">False</td>
    <td class="tg-baqh">False</td>
  </tr>
  <tr>
    <td class="tg-wa1i" rowspan="3">Compatibilism</td>
    <td class="tg-wa1i" rowspan="2">Soft compatibilism</td>
    <td class="tg-wa1i">Soft determinism</td>
    <td class="tg-nrix">True</td>
    <td class="tg-nrix">True</td>
    <td class="tg-nrix">True</td>
  </tr>
  <tr>
    <td class="tg-amwm">Soft non-determinist compatibilism</td>
