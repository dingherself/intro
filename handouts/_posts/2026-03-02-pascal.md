...
- Maimonides on divine providence [35 min]
- Pascal’s wager [30 min]
...
Example: *Severance* is a brilliant TV show.
...
- Is this enough for “true” belief? [Anya, Leah, Zohia, Anika, Samantha, Megan, Lucy]
...
<table class="tg mb-5"><thead>
  <tr>
    ...
    <th class="tg-0lax">Friend @ Transit Museum (75%)</th>
  </tr></thead>
<tbody>
  <tr>
  ...
  <tr>
    <td class="tg-0lax">Go to Transit Museum</td>
    <td class="tg-baqh">25</td>
...
- EU<sub>TM</sub> = 25% × 25 + 75% × 100 = 81.25
...
Can you run the argument over and over again for many, many Gods—even beyond actual world religions? [Sophie, Zi]
...
What if God is a philosopher who wants you to believe only what you have good epistemic reasons to believe? [Zohia]
